...
The YAML configuration file (shown below) has five major sections: 1) Factory Settings, 2) Default Application Name, 3) Process Filters, 4) IP Filters, & 5) URL Filters.
