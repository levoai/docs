...
Levo provides pre-build AMIs for Satellite. You can launch an EC2 instance using the AMI in the AWS region you wish to install the satellite in.

<Tabs groupId="satellite-ami">
  <TabItem value="mac" label="Mac OSX">
    <ul>
      <li> <a href="https://us-west-2.console.aws.amazon.com/ec2/home?region=us-west-1#LaunchInstances:ami=ami-0c0280a6a37e5a5d1;instanceType=c6a.xlarge">us-west-1 (N. California)</a> </li>
      <li> <a href="https://us-west-2.console.aws.amazon.com/ec2/home?region=us-west-2#LaunchInstances:ami=ami-0056e875e2c82dd26;instanceType=c6a.xlarge">us-west-2 (Oregon)</a> </li>
      <li> <a href="https://us-west-2.console.aws.amazon.com/ec2/home?region=us-east-1#LaunchInstances:ami=ami-0a69a719704386c2a;instanceType=c6a.xlarge">us-east-1 (N. Virginia)</a> </li>
      <li> <a href="https://us-west-2.console.aws.amazon.com/ec2/home?region=us-east-2#LaunchInstances:ami=ami-04d71c93f46bc4543;instanceType=c6a.xlarge">us-east-2 (Ohio)</a> </li>
    </ul>
  </TabItem>
</Tabs>
...
### 2. EC2 Configuration
Pick the following appropriately for your instance. Make sure that this instance will be reachable for the eBPF sensors running in your VPC.
...
```bash
#!/bin/bash
echo "LEVOAI_AUTH_KEY=levo_auth_key" > /opt/levoai/.env
/opt/levoai/levo_satellite.sh start >> satellite-start.log 2>&1
```

### 4. Launch the EC2 instance
Satellite should be up and running once the EC2 instance is lauched and in running state.
...
```bash
sudo docker logs levoai-tagger | grep "Ready to process; waiting for messages."
```
If connectivity is healthy, you will see output similar to below.
