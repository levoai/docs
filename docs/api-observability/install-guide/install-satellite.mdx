...
<Tabs groupId="satellite-ami">
  <TabItem value="mac" label="Mac OSX">
    <ul>
      <li> <a href="https://us-west-2.console.aws.amazon.com/ec2/home?region=us-west-1#LaunchInstances:ami=ami-0e7e16a896387d53e;instanceType=c6a.xlarge">us-west-1 (N. California)</a> </li>
      <li> <a href="https://us-west-2.console.aws.amazon.com/ec2/home?region=us-west-2#LaunchInstances:ami=ami-01179c55c0bd2a6af;instanceType=c6a.xlarge">us-west-2 (Oregon)</a> </li>
      <li> <a href="https://us-west-2.console.aws.amazon.com/ec2/home?region=us-east-1#LaunchInstances:ami=ami-0ec6df39e74076054;instanceType=c6a.xlarge">us-east-1 (N. Virginia)</a> </li>
      <li> <a href="https://us-west-2.console.aws.amazon.com/ec2/home?region=us-east-2#LaunchInstances:ami=ami-0b1d5b219834fb78a;instanceType=c6a.xlarge">us-east-2 (Ohio)</a> </li>
    </ul>
  </TabItem>
</Tabs>
...
```bash
#!/bin/bash
echo "LEVOAI_AUTH_KEY=xxx" > /opt/levoai/.env
...
# /opt/levoai/levo_traffic_listener.sh start >> traffic-listener-start.log 2>&1
```
