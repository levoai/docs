...
Please contact <a href="mailto:support@levo.ai">Support</a> with the diagnostic information provided by the script. We will provide a compatible Sensor promptly.

-------------------------------------------------------
## Supported Platforms

Please see [Platforms](/guides/general/supported-platforms.md).