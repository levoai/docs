...
>
    ...
    <TabItem value="tf">
        ...
        Enter the AWS Region and Satellite Refres Token as prompted to create a task definition in your AWS account.
...
Check [AWS Traffic Mirroring](/api-observability/install-guide/install-sensor/aws-traffic-mirroring.md) for configuring traffic mirroring using Levo CLI.
