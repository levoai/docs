...
**Please contact <a href="mailto:support@levo.ai">Support</a> if you notice health/connectivity related errors.**
...
If you want to use a private docker registry for the satellite installation, refer to [Using a Private Docker Registry for Kubernetes Installations](/guides/general/private-registry.md).


### Using a Custom Ingress Controller (Optional)
In case you want to use a custom ingress controller, contact <a href="mailto:support@levo.ai">Support</a> for assistance.


### Next Steps: Install Traffic Capture Sensors
Proceed to [install Traffic Capture Sensors](/install-traffic-capture-sensors) to deploy sensors in your environment.
...
If there are exception messages, you have an incorrect or stale `Authorization Key`. Please contact <a href="mailto:support@levo.ai">Support</a> for further assistance.
...
If there are exception messages, Tagger is unable to connect to dependent services. It generally establishes connection after 3/4 retries. Please contact <a href="mailto:support@levo.ai">Support</a> for further assistance.
...
### Need Help?
For further assistance, please reach out to <a href="mailto:support@levo.ai">Support</a>.
